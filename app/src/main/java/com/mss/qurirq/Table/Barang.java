...
public class Barang {
    ...
    @Expose
    private Double hargaJl;
    @SerializedName("harga_jl2")
    @Expose
    private Double hargaJl2;
    @SerializedName("harga_jl3")
    @Expose
    private Double hargaJl3;
    @SerializedName("harga_jl4")
    @Expose
    private Double hargaJl4;
    ...
    public Double getHargaJl() {
        return hargaJl;
    }

    public void setHargaJl(Double hargaJl) {
        this.hargaJl = hargaJl;
    }

    public Double getHargaJl2() {
        return hargaJl2;
    }

    public void setHargaJl2(Double hargaJl2) {
        this.hargaJl2 = hargaJl2;
    }

    public Double getHargaJl3() {
        return hargaJl3;
    }

    public void setHargaJl3(Double hargaJl3) {
        this.hargaJl3 = hargaJl3;
    }

    public Double getHargaJl4() {
        return hargaJl4;
    }

    public void setHargaJl4(Double hargaJl4) {
